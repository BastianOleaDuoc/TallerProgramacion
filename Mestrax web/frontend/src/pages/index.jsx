    ...
    <>
      <section className="hero-modern container text-center py-5 mt-4">
        ...
        <div className="d-flex justify-content-center gap-3 flex-wrap">
          <a href="/#productos" className="btn-primary-modern btn btn-lg px-4">Ver menú completo</a>
          <a href="/#reserva" className="btn-secondary-modern btn btn-lg px-4">Reservar mesa</a>
        </div>
      </section>
