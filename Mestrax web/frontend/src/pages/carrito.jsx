...
export default function Carrito({ usuario, carrito, actualizarCarrito }) {
  ...
  const finalizarPedido = async () => {
    ...
    try {
      ...
      setError('No se pudo registrar la venta. Revisa que el backend este ejecutandose.');
    } finally {
    ...
    <main className="container py-5 page-shell">
      ...
      {items.length === 0 ? (
        <section className="card p-4 text-center shadow">
          <p className="mb-3">{mensaje || 'Tu carrito esta vacio'}</p>
          ...
          <div className="card glass-panel p-3 mt-4">
            <div className="row g-3 align-items-end">
              ...
              <div className="col-md-7 text-md-end">
                <p className="text-muted mb-1">La venta quedara registrada en el panel admin.</p>
