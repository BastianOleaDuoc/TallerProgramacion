...
export default function Producto({ carrito, actualizarCarrito }) {
  ...
  const agregarAlCarrito = (producto) => {
    ...
    if (productoNormalizado.estado !== 'Disponible') {
      alert(`${productoNormalizado.nombre} no esta disponible por ahora`);
      return;
    }
    ...
    alert(`Producto agregado\n${productoNormalizado.nombre} ya esta en tu carrito`);
  };

  return (
    <main className="container py-5 page-shell">
      <section className="text-center mb-5 mt-3">
        <div className="badge-modern mb-3">Menu Exclusivo</div>
        <h2 className="fw-bolder m-0 display-5">Nuestra <span className="text-gradient">Seleccion</span></h2>
      </section>
      ...
      <section>
        {loading ? (
          <div className="text-center text-white py-5">Cargando menu...</div>
                  ...
                  <div className="card h-100">
                    ...
                    <div className="card-body d-flex flex-column">
                      <div className="d-flex justify-content-between gap-2 align-items-start mb-1">
                        <h5 className="card-title fw-bold text-white mb-0">{producto.nombre}</h5>
